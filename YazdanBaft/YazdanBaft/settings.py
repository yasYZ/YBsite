"""
Django settings for YazdanBaft project.
...
SECRET_KEY = '99=w97uhntr#r1-lap!=lm79yh8t756pkhcmljfjnb&z(!m_qg'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'home.context_processors.seo_context_processor',
            ],
        },
    },
]

WSGI_APPLICATION = 'YazdanBaft.wsgi.application'
